...
@shared_task
def send_payment_past_due_email(data):
    """
    A Celery task to send a "payment past due" reminder email.
    ...
    try:
        ...
        print(f"Payment past due reminder sent to {subscriber_email}")

    except Exception as e:
        # Log any exceptions that occur during email sending.
        print(f"Error sending payment past due reminder: {e}")
